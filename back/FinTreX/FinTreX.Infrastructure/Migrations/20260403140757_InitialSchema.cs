        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MonthlyPriceTRY = table.Column<decimal>(type: "decimal(10,2)", precision: 10, scale: 2, nullable: false),
                    MaxEconomists = table.Column<int>(type: "int", nullable: false),
                    CanChangeEconomist = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EconomistId = table.Column<string>(type: "nvarchar(450)", maxLength: 450, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ParentPortfolioId = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ConsultancyTaskId = table.Column<int>(type: "int", nullable: false),
                    Summary = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
                    RiskLevel = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    MarketOutlook = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrentValue = table.Column<decimal>(type: "decimal(18,6)", precision: 18, scale: 6, nullable: true),
                    CurrentValueUpdatedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "CanChangeEconomist", "Description", "DisplayName", "HasPrioritySupport", "IsActive", "MaxEconomists", "MonthlyPriceTRY", "Tier" },
                values: new object[,]
                {
                    { 1, false, "Temel erişim — 1 ekonomist ataması, değiştirilemez.", "Ücretsiz", false, true, 1, 0m, "Default" },
                    { 2, true, "Gelişmiş erişim — 3 ekonomist, değiştirilebilir, genişletilmiş analiz.", "Premium", false, true, 3, 49.99m, "Premium" },
                    { 3, true, "Sınırsız erişim — sınırsız ekonomist, öncelikli destek, tam analiz.", "Ultra", true, true, 999, 149.99m, "Ultra" }
                });
